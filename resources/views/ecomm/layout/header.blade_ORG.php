            ...
            <nav class="navbar navbar-expand-lg bg-light navbar-light py-0 px-0 top_menue_bar">
                ...
                <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                    ...
                    <div class="navbar-nav ml-auto py-0">
                        ...
                        <a href="{{ url("{$ecommbaseurl}login") }}" class="nav-item nav-link  d-none d-lg-block {{ @$login }}">Login</a>
                        <a href="{{ url("{$ecommbaseurl}register") }}"  class="nav-item nav-link d-none d-lg-block  {{ @$register }}">Register</a>
