      ...
      <div class="border-bottom mb-2 pb-2">
        <h5 class="font-weight-semi-bold mb-4">Matterial</h5>
          <!-- <div class="custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3">
            <input type="checkbox" name='' class="custom-control-input" id="matter-all" value="all" >
            <label class="custom-control-label matter_label" for="matter-all" id="matter_all">All</label>
