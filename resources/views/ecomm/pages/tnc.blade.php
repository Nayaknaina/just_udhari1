...
<div class="container-fluid bg-secondary mb-5 breadcrumb-section p-0 d-md-block d-none">
  <div class="d-flex flex-column align-items-center justify-content-center  p-2">
    <!--<h1 class="font-weight-semi-bold text-uppercase mb-3">Terms & Conditions</h1>-->
	<h3 class="font-weight-semi-bold text-uppercase mb-3 text-white">Terms & Conditions</h3>
...
<div class="container-fluid bg-secondary mb-5 p-0 d-block d-md-none">
	<ul class="mob_breadcrumb w-100">
		<li class="page_head p-1 text-center"><h3 class="font-weight-semi-bold text-uppercase text-white m-0">Terms & Conditions</h3></li>
...
<div class="container-fluid pt-5">
  <div class="text-center mb-4">
    <h2 class="section-title px-5"><span class="px-2">Our Terms & Conditions</span></h2>
  </div>
