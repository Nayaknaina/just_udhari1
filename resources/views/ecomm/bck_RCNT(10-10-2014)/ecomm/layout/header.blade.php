    ...
    <div class="row bg-secondary py-2 px-xl-5">
        <div class="col-lg-6 d-none d-lg-block">
            <div class="d-inline-flex align-items-center">
                @php
                    $dummy = true;
                    $head_mail = "mgjewellers.bpl@gmail.com";
                    $head_fone = "+91-9826262335";
                @endphp
                @if(!$dummy)
                    @php
                    $head_contact_common = $common_content['contact'];
                    if($head_contact_common){
                        $mail_vis = ($head_contact_common->contact_email_vis=='all')?'one':$head_contact_common->contact_email_vis;
                        $fone_vis = ($head_contact_common->contact_fone_vis=='all')?'one':$head_contact_common->contact_fone_vis;

                        $head_mail = $head_contact_common->{"contact_email_{$mail_vis}"};
                        $head_fone = $head_contact_common->{"contact_fone_{$fone_vis}"};
                    }
                    @endphp
                @endif
