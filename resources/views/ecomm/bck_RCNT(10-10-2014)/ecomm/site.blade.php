...
<head>
    <meta charset="utf-8">
    <title>@yield('title')  MG Jewellers </title>
    <meta content="width=device-width, initial-scale=1.0" name="viewport">
    <meta content="Free HTML Templates" name="keywords">
    <meta content="Free HTML Templates" name="description">

    <!-- Favicon -->
    <link href="{{ asset('assets/ecomm/logo.webp')}}" rel="icon">
    ...
    <link href="{{ asset('assets/ecomm/css/own_custom_black.css') }}" rel="stylesheet">
    @stack('css')
