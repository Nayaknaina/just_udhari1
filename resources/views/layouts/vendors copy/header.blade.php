<div class="page-header">
    <div class="header-wrapper row">
      ...
      <svg class="stroke-icon toggle-sidebar">
        <use class="status_toggle middle sidebar-toggle" href="https://admin.pixelstrap.com/cion/assets/svg/icon-sprite.svg#Grid"> </use>
      </svg>
          ...
          <div class="Typeahead Typeahead--twitterUsers">
            <div class="u-posRelative">
              ...
              <svg class="search-bg svg-color">
                <use href="https://admin.pixelstrap.com/cion/assets/svg/icon-sprite.svg#Search"></use>
              </svg>
            </div>
        ...
        <ul class="nav-menus">
          ...
          <li class="onhover-dropdown">
            <div class="notification-box">
              <svg>
                <use href="https://admin.pixelstrap.com/cion/assets/svg/icon-sprite.svg#Bell"></use>
              </svg>
            </div>
          ...
          <li class="onhover-dropdown">
            <svg>
              <use href="https://admin.pixelstrap.com/cion/assets/svg/icon-sprite.svg#Bookmark"></use>
            </svg>
          ...
          <li class="onhover-dropdown message-box">
            <div class="message notification-box">
              <svg>
                <use href="https://admin.pixelstrap.com/cion/assets/svg/icon-sprite.svg#Message"></use>
          ...
          <li class="cart-nav onhover-dropdown">
            <div class="cart-box">
              <svg>
                <use href="https://admin.pixelstrap.com/cion/assets/svg/icon-sprite.svg#Buy"></use>
              </svg>
            </div>
          ...
          <li>
            <div class="mode">
              <svg>
                <use href="https://admin.pixelstrap.com/cion/assets/svg/icon-sprite.svg#moon"></use>
              </svg>
            </div>
          </li>
      ...
      <script class="result-template" type="text/x-handlebars-template">
        ...
        <div class="ProfileCard-realName"> sd</div>
        </div>
        </div>
      </script>
