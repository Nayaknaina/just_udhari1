    ...
    <footer class="footer-area footer-bg">
        <div class="container">
            ...
            <div class="copy-right-area row">
                <div class="policies col-md-4 col-12 p-0 text-center policy_area">
                    <a href="{{ route('policy','privacy') }}" class="px-1"><u>Privacy Policy</u></a>
                    <a href="{{ route('policy','term') }}" class="px-1"><u>Term & Conditions</u></a>
                    <a href="{{ route('policy','refund') }}" class="px-1"><u>Refund Policy</u></a>
                </div>
                <div class="copy-right-text col-md-8 col-12 p-0">
                    <p>
                        Copyright ©
                        <script>
