...
<!------------------96 Table css Custom----------------------------->
<link rel="stylesheet" type="text/css" href="{{ asset('main/assets/css/elements/tables.css')}}">
<link rel="stylesheet" type="text/css" href="{{ asset('main/assets/css/elements/form_content.css')}}">
<!--------------END : 96 Table css Custom--------------------------->
...
<link rel="stylesheet" href = "{{ asset('main/assets/css/nowmenu.css')}}">
...
<style>
    ...
    /*.layout-px-spacing{
        box-shadow:1px 2px 4px gray inset;
		border-top: 1px solid #f85600;
    }
	nav#compactSidebar{
