              ...
              <div class="row">
                ...
                <div class="col-lg-12">
                  ...
                  <div class="col-lg-3 form-group">
                        ...
                        <div class="form-inline">
                            <label for="start_fix" class="form-control col-6 text-center start">
                                <input type="radio" name="start" value="1" id="start_fix"  {{ ($scheme->start_date_fix=='1')?'checked':'' }} required> FIXED 
                            </label>
                            <label for="start_enroll"  class="form-control col-6 text-center start">
                                <input type="radio" name="start" value="0" id="start_enroll" {{ ($scheme->start_date_fix=='0')?'checked':'' }} required > ENROLLED
                            </label>
                        </div>
                    </div>
                  ...
                  <div class="col-lg-4 form-group">
                    ...
                    <div class="form-inline">
                        <label for="lucky_draw_no" class="form-control col-6 text-center lucky_draw"><input type="radio" name="lucky_draw" value="0" id="lucky_draw_no" onclick="toggleinterest()"  {{ ($scheme->lucky_draw=='0')?'checked':'' }} onclick="toggleinterest()"> No </label>
                        <label for="lucky_draw_yes"  class="form-control col-6 text-center lucky_draw"><input type="radio" name="lucky_draw" value="1" id="lucky_draw_yes" onclick="toggleinterest()" {{ ($scheme->lucky_draw=='1')?'checked':'' }} onclick="toggleinterest()"> Yes</label>
                    </div>
                  ...
                  <div class="col-lg-4 form-groups" id = "interest_main_sec" style = "display:{{ ($scheme->lucky_draw=='1')?'none':'' }};" >
                  ...
                  <div class="col-lg-4 form-group" style="display:@if($scheme->interest_type=='No') none @endif" id="interest_block" style="display:display:{{ ($scheme->lucky_draw=='1')?'none':'' }};">
