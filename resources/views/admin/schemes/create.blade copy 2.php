            ...
            <form id = "submitForm" method="POST" action="{{ route('schemes.store')}}" class = "myForm" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 form-group ">
                        ...
                        <div class="input-group">
                            <input type="number" name ="valid" id = "valid" class="form-control form-group text-center"  placeholder = "Enter Scheme Amount" min = "1" >
                        </div>
                    </div>

                    <div class="col-lg-3 form-group">
                        <label for="emi"> EMI <span class = "text-danger"> ( (Monthly)) * </span></label>
                    ...
                    <div class="col-lg-3 form-groups">
                        ...
                        <div class="form-inline">
                            <label for="interest_no" class="form-control col-6 text-center"><input type="radio" name="interest" value="No" id="interest_no" checked onClick="if($(this).is(':checked')){ $('#interest_block').hide(); }"> NO</label>
                            <label for="interest_yes"  class="form-control col-6 text-center"><input type="radio" name="interest" value="Yes" id="interest_yes" onClick="if($(this).is(':checked')){ $('#interest_block').show(); }"> Yes</label>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-12 form-group">
                        ...
                        <textarea name="detail_one" id="detail_one" class="form-control  ckeditor" placeholder="Enter description"></textarea>
                    </div>
                    ...
                    <div class="col-lg-12 form-group">
                        ...
                        <textarea name="detail_two" id="detail_two" class="form-control  ckeditor" placeholder="Enter description"></textarea>
                    </div>
                    <div class="col-12 form-group">
