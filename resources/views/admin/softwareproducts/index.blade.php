...
@section('content')
    ...
    <a class = "btn btn-outline-primary" href = "{{route('softwareproducts.create')}}"><i class="fa fa-plus"></i>  Add New </a>
    </div>
    ...
    <input type="text" id = "title" class = "vin_no form-control" placeholder = "Search Title"  onchange="changeEntries()" >
    </div>
