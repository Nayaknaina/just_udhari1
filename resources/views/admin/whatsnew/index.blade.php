...
@section('content')
    ...
    <div class="card ">
        <div class="card-header">
            ...
            <a class = "btn btn-outline-primary" href = "{{route('whatsnew.create')}}"><i class="fa fa-plus"></i>  Add New </a>
        ...
        <input type="text" class = "name form-control" placeholder = "Search..."  onkeyup="changeEntries()" >
        </div>
...
@endsection
  ...
  <script>
    ...
    var route = "{{ route('whatsnew.index') }}";
