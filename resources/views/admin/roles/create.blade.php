...
@section('content')
    ...
    $data = component_array('breadcrumb' , 'Roles' ,['title' => 'Roles'] ) ;
  ...
  <a class = "btn btn-outline-primary" href = "{{route('roles.index')}}"><i class="fa fa-arrow-left"></i>  Back </a>
  </div>
    ...
    $(document).ready(function() {
        ...
        $('#submitForm').submit(function(e) {
            ...
            $.ajax({
                ...
                window.open("{{route('roles.create')}}", '_self') ;
                },
