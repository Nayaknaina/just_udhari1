...
@php
$label = ucfirst($type);
//$data = component_array('breadcrumb' , "{$label } Transactions",[['title' => 'Ecomm-Txns']] ) ;

@endphp

{{--<x-page-component :data=$data />--}}
@php 
$data = new_component_array('newbreadcrumb',"Ecomm {$label} Txns") 
@endphp 
<x-new-bread-crumb :data=$data /> 
    ...
    <!--<div class="card-header">
      <h5 class="card-title">{{ $label }} Transactions</h5>
    </div>-->
    ...
    <form action=""> 
      <div class="row">
        ...
        <div class="col-12 col-md-4  form-group">
          ...
          <input type="text" id = "custo" name="custo" class = "form-control" placeholder = "Search Name/Mobile"  oninput="changeEntries()" >
        </div>
        ...
        <input type="text" id = "txn" name="txn" class = "form-control" placeholder = "Search Transaction"  oninput="changeEntries()" name="txn">
        </div>
        ...
        <div class="col-12 col-md-3  form-group">
          ...
          <input type="text" id = "medium" name="medium" class = "form-control" placeholder = "Enter Pay Medium"  oninput="changeEntries()" >
        </div>
...
@endsection
  ...
  <script>
    ...
    const get_route = "{{ route('ecomorders.txns',$type) }}";

    function getresult(url) {
      const load_tr = '<tr><td class="text-center" colspan="{{ ($type=='scheme')?'12':'11' }}"><span style="background: lightgray;font-size:15px;"><li class="fa fa-spinner fa-spin"></li>Loading Content..</span></td></tr>'
