...
//$data = component_array('breadcrumb' , 'Refund Policy',[['title' => 'Pages']] ) ;

@endphp

{{--<x-page-component :data=$data />--}}
@php $data = new_component_array('newbreadcrumb',"Ecomm Refund Policy") @endphp 
...
<div class="container-fluid">
  ...
  <div class="row justify-content-center">
    ...
    <div class="card-body">
       ...
       <form action="{{ route("refundpolicy") }}" method="post" role="form" id = "term_content_form" class="{{ (@$existrefund->refp_status==0)?'deactive':'' }}">

        @csrf

          <div class="form-group col-md-12">
               <label for="intro" class="required_label col-12">Privacy Policy <a href="{{ route('refundpolicy.status') }}" class="switch {{ (@$existrefund->refp_status==0)?'off':'on' }}"></a></label>
               <textarea class="form-control ckeditor" id = "info" >{{ @$existrefund->refp_content }}</textarea>
          </div>
