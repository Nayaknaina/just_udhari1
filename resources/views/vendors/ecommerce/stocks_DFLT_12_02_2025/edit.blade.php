        ...
        <div class = "row justify-content-center">
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    ...
                    <input type="text" name="name" class="form-control form-group" placeholder="Enter Product Name" value = "{{ $ecomstock->name }}" >
                </div>

                <div class="col-lg-6">
                    <label for=""> Rate <span class = "text-danger"> * </span> </label>
                    <input type="number" name="rate" class="form-control form-group" placeholder="Enter Rate" min = "1" step = "any">
                </div>

                <div class="col-lg-6">
                    <label for=""> Weight <span class = "text-danger">  </span> </label>
                    <input type="text" name="net_weight" class="form-control form-group" placeholder="Enter Rate" value = "{{ $ecomstock->net_weight }}" readonly  >
                </div>

                <div class="col-lg-6">
                    <label for=""> Purchase Amount <span class = "text-danger">  </span> </label>
                    <input type="text" name="amount" class="form-control form-group" placeholder="Enter Amount" value = "{{ $ecomstock->amount }}" readonly  >
                </div>
