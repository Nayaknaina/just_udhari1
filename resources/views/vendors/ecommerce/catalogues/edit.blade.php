...
$data = new_component_array('newbreadcrumb' , 'Edit Catalogue',$path_arr) ;
...
<section class = "content">
  <div class = "container-fluid">
      <div class = "row justify-content-center">
          ...
          <form id = "submitForm" method="POST" action="{{ route('catalogues.update',$catalogue->id)}}" class = "myForm" enctype="multipart/form-data">
          ...
          <div class="row">
              ...
              <div class="col-lg-12">
                  <label for=""> Cataloge Name </label>
                  <input type="text" name = "name" class="form-control form-group" placeholder="Enter Cataloge Name" value = "{{ $catalogue->name }}">
              </div>

              <div class="col-lg-6 mb-3">
                  <label for=""> Cataloge Thumnail Image </label>
              ...
              <div class="col-lg-6 mb-3">
                  <label for=""> Cataloge More Image </label>
              ...
              <div class="col-lg-6">
                  ...
                  <input type = "number" name = "weight" class="form-control form-group" placeholder = "Enter Weight"  min = '1' step='any' onkeyup="limitDecimalPlaces(this, 3)"  value = "{{ $catalogue->weight }}" >
              </div>

              <div class="col-lg-6 dss" >
                  <label for=""> Price </label>
                  <input  id="short_order_input" type = "number" name = "price" class="form-control form-group" placeholder = "Enter Price" min = '1'  step='any' onkeyup="limitDecimalPlaces(this, 2)"  value = "{{ $catalogue->price }}" >
              </div>
              ...
              <div class="col-lg-6">
                  ...
                  <select name = "metals" class = "form-control select2 ">
                   ...
                   @foreach ($metals as $metal)
                      <option value = "{{ $metal->id }}" @if(@$catalogue->catalogecategories[0]->id == $metal->id) selected @endif > {{ $metal->name }} </option>
                   @endforeach
                  </select>
                  </div>
              </div>
              ...
              <div class="col-lg-6">
                  ...
                  <select name = "collections" class = "form-control select2 " >
                   ...
                   @foreach ($collections as $collection)
                      <option value = "{{ $collection->id }}" @if(@$catalogue->catalogecategories[1]->id == $collection->id) selected @endif > {{ $collection->name }} </option>
                   @endforeach
                  </select>
                  </div>
              </div>
              ...
              <div class="col-lg-6">
                  ...
                  <select name = "categories" class = "form-control select2 ">
                   ...
                   @foreach ($categories as $category)
                      <option value = "{{ $category->id }}" @if(@$catalogue->catalogecategories[2]->id == $category->id) selected @endif > {{ $category->name }} </option>
                   @endforeach
                  </select>
                  </div>
              </div>
              ...
              <div class="col-lg-6">
                  ...
                  <input type="number" name="short_order" class="form-control form-group" placeholder="Enter Show Order" min='1' step='1'  value = "{{ $catalogue->short_order }}"  >
              </div>
