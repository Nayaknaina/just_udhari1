    ...
    <div class="card-body p-2">
        ...
        <div class="col-md-9">
            <ul class="scheme_attr row p-0">
                ...
                <li class="col-md-4"><strong class="attr_title">EMI</strong><span class="attr_value">{{ ($schemedetail->emi_range_start != $schemedetail->emi_range_end)?"{$schemedetail->emi_range_start} - {$schemedetail->emi_range_end}":"{$schemedetail->emi_range_start}" }} Rs.</span></span></li>
            ...
            <ul class="scheme_attr row p-0">
                <li class="col-md-4"><strong class="attr_title">Start Date</strong><span class="attr_value">{{ ($schemedetail->launch_date!="")?$schemedetail->scheme_date:"dd-mm-yyyy"; }}</span></li>
