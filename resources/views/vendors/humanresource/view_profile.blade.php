...
@php $data = new_component_array('breadcrumb',"View Profile") @endphp
                                        ...
                                        <div class=" mb-2">
                                            <div class="profile-title d-flex">
                                                <div class="d-flex align-items-center py-2" style="position: relative; width: max-content;">
                                                    <img id="profileImage" class="img-70 rounded-circle" alt="Profile" src="/main/assets/img/profile-30.png" style="object-fit: cover;width:83px;">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6 col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control h-32px btn-roundhalf border-dark" type="text" placeholder="PinCode">
                                            </div>
                                        </div>
                                        <div class="col-sm-6 col-md-4">
                                            <div class="mb-3">
                                        ...
                                        <div class="col-sm-6 col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control h-32px btn-roundhalf border-dark" type="text" placeholder="State">
                                            </div>
                                        </div>
                                        <!-- Resume Upload -->
