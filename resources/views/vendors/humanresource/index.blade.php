                                    ...
                                    <div class="d-flex gap-2">
                                        <div class="col-md-4 py-0 px-1">
                                            <div class="input-group position-relative mb-0">
                                                ...
                                                <a href="{{route('vendor.outsource.hrm.add')}}" class="add-btn"><span class="add-icon">+</span></a>
                                            </div>
                                        </div>
                                                ...
                                                <div class="action-buttons">
                                                    ...
                                                    <div class="hover-menu-wrapper">
                                                        ...
                                                        <div class="hover-menu">
                                                            <a href="{{ route('vendor.outsource.hrm.attendance') }}">Attendance List</a>
                                            ...
                                            <td class="text-center">
                                                <div class="dropdown d-inline-block">
                                                    ...
                                                    <div class="dropdown-menu left dot-menu" aria-labelledby="elementDrodpown1" style="will-change: transform;">
                                                        <a class="dropdown-item" href="{{route('vendor.outsource.hrm.view')}}">View <i class="fa-solid text-success fa-eye"></i></a>
                                                        <a class="dropdown-item" href="{{route('vendor.outsource.hrm.view')}}">Edit <i class="fa-solid text-warning fa-pen-to-square"></i> </a>
