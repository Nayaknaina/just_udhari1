                        ...
                        <div class="row mb-2" style="border-bottom:1px solid #a6a6a6;">
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="custo_name" id="custo_name" class="form-control" placeholder="Customer Name" oninput="existingcustomer()"  >
                                    <ul class="col-12" id="custo_list" style="display:none;"></ul>
                                    <input type="text" name="custo_mobile" id="custo_mobile" class="form-control" placeholder="Customer Mobile"  oninput="digitonly(event,10);" onchange="digitonly(event,10);">
                                ...
                                <table class="table table-bordered table-stripped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr id="item_{{ $i }}" class="item_row">
                                            ...
                                            <td class="bg-light text-dark">
                                                <input type="text" name="curr_rate" class="form-control item_info" value="" id="" disabled >
                                            </td>
                                            
                                            <td class="bg-light text-dark">
                                                <input type="text" name="curr_make" class="form-control item_info" value="" id="" disabled>
                                            </td>
                                            
                                            <td class="bg-light text-dark">
                                                <input type="text" name="curr_avail" class="form-control item_info" value="" id="" disabled>
                                            </td>
                                            <td>
                                                <input type="text" name="item_wght[]" class="form-control w-100 item_info  text-right" placeholder="Weight" oninput="calculatetotal()">
                                            </td>
                                            <td>
                                                <input type="text" name="item_count[]" class="form-control w-100 item_info  text-right" placeholder="Quantity"  oninput="calculatetotal()">
                                            </td>
                                            <td>
                                                <input type="text" name="item_cost[]" class="form-control w-100 item_info  text-right" placeholder="Cost"  oninput="calculatetotal()" {{ ($i==0)?'required':'' }} >
                                            </td>
                                            <td>
                                                <input type="text" name="item_chrg[]" class="form-control w-100 item_info  text-right" placeholder="Charge"  oninput="calculatetotal()">
                                            </td>
                                            <td>
                                                <input type="text" name="item_total[]" class="form-control w-100 item_info  text-right" placeholder="Total"  readonly {{ ($i==0)?'required':'' }}>
                                            </td>
                                        </tr>
                                        @endfor
                                    </tbody>
                                    <tfoot>
                                        <tr class="bg-light">
                                            ...
                                            <td>
                                                <input type="text" name="total_wght" class="form-control item_info readonly  text-right" value="" id="" readonly required style="font-weight:bold;">
                                            </td>
                                            <td>
                                                <input type="text" name="total_count" class="form-control item_info readonly  text-right" value="" id="" readonly required style="font-weight:bold;">
                                            </td>
                                            <td>
                                                <input type="text" name="total_cost" class="form-control item_info readonly  text-right" value="" id="" readonly required style="font-weight:bold;">
                                            </td>
                                            <td>
                                                <input type="text" name="total_make" class="form-control item_info readonly  text-right" value="" id="" readonly required style="font-weight:bold;">
                                            </td>
                                            <td>
                                                <input type="text" name="total_sum" class="form-control item_info readonly  text-right" value="" id="" readonly required style="font-weight:bold;">
                                            </td>
                                        </tr>
                                    </tfoot>
                                </table>
