<table class = "table table-responsive table-bordered" id="h">
            <thead class = "bg-info">
                <tr>
                    <th> SN </th>
                    <th> Product Name </th>
            ...
            <tbody id="tableBody" class="item_tbody">
                <tr id="main_item_tr_1" class="main_item_tr">
                    ...
                    <td class="text-center"> 
                        <input type="number"  class="tb_input calculate_item quantity" name="quantity[0][]" id="quantity_1" placeholder="Quantity" oninput="calculate(this)" min = "0" step = "any" value="1" readonly style="width:50px;"> 
                    </td>
                    <td> 
                    ...
                    <td> 
                        <input type="number" class="tb_input calculate_item gross_weight" name="gross_weight[0][]" id="grossWeight_1 floatInput" placeholder="Gross Weight " oninput="calculate(this)"  min = "0" step = "0.001" style="width:80px;"> 
                    </td>
                    <td> 
                        <input type="number" class="tb_input calculate_item net_weight" name="net_weight[0][]" id="netWeight_1" placeholder="Net Weight" oninput="calculate(this)"  min = "0" step = "any"  style="width:80px;"> 
                    </td>
                    <td> 
                        <input type="number" class="tb_input calculate_item purity" name="purity[0][]" id="purity_1" placeholder="Purity" oninput="calculate(this)" min = "0" step = "any" style="width:80px;"> 
                    </td>
                    <td> 
                        <input type="number" class="tb_input calculate_item waste" name="wastage[0][]" id="wastage_1" placeholder="Wastage" oninput="calculate(this)" min = "0" step = "any" style="width:80px;"> 
                    </td>
                    <td> 
                    ...
                    <td> 
                        <input type="number" class="tb_input calculate_item labour" name="labour_charge[0][]" id="labourCharge_1" placeholder="Labour Charge" oninput="calculate(this)" min = "0" step = "any" style="width:80px;"> 
                    </td>
                    <td> 
