<table class = "table table-responsive table-bordered genuine" id="h">
    ...
    <tbody id="tableBody" class="item_tbody">
        <tr id="main_item_tr_1" class="main_item_tr">
            ...
            <td> 
                <input type="number" class="tb_input calculate_item labour" name="labour_charge[0][]" id="labourCharge_1" placeholder="Per Gram"  min = "0" step = "any" style="width:80px;"> 
            </td>
            <td> 
                <input type="number" class="tb_input calculate_item total" name="total_charge[0][]" id="totalCharge_1" placeholder="Total"  min = "0" step = "any" style="width:80px;"> 
            </td>
            <td> 
