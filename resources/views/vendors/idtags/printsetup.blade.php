            ...
            <div class="row">
                ...
                <div class="col-md-{{ ($sizes->count()>0)?7:9 }} mt-2">
                    <div class="machine m-auto" style="background:gray;">
                        <div id="qr_tag" class="tag">
                            <div id="qr_code">
                                <img src="{{ asset('assets/images/dummy/qr_dummy.png') }}">
                            </div>
                            <div id="qr_weight">
                                <p><b>GROSS-</b><span id="qr_gross">100gm</span></p>
                                <p><b>LESS-</b><span id="qr_less">1gm</span></p>
                                <p><b>NET-</b><span id="qr_net">99gm</span></p>
                            </div>
                            <div id="unique">
                                <p><b>ID-</b><span id="id">prct-id</span></p>
                                <p><b>CODE-</b><span id="id">code</span></p>
                            </div>
                        </div>
