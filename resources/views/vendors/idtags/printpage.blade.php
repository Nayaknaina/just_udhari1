...
<div id="machine" class="machine m-auto"  >
    <input type="hidden" name="code_type" sdsd id="code_type" value="{{ $req_code }}">
    ...
    @foreach($stock as $si=>$stk)
        ...
        <div class="col-12 text-center">
            <br>
            <button type="button" class="btn btn-sm btn-dark" type="button" id="zebra_print" data-stock="{{ $stock_type }}">
                <i class="fa fa-print"></i> Print Tag
            </button>
        </div>
@else 
