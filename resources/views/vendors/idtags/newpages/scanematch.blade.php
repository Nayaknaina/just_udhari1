...
@section('content')
@php 
$anchor = ['<a href="'.route('stock.idtags.generate').'" class="btn btn-sm btn-outline-secondary py-1"><i class="fa fa-list"></i> Generate/Print</a>'];
...
function data(){
    ...
    //let path = "{{ route('idtags.getitem') }}"+url_add_on;
    let item_row = '';
    let num = 0;
    let ttl_gross = 0;
    let ttl_net = 0;
    ...
    $.get(url+url_add_on,'',function(response){
        ...
        if(response.data.length > 0){
            ...
            $.each(response.data,function(i,v){
                num = i + 1;
                item_row+= '<tr id="avail_'+code+'_'+v.tag+'">';
                item_row+='<td class="sn">'+ num +'</td>';
                item_row+='<td>';
                item_row+='<ul>';
                item_row+='<li>NAME : '+v.name+'</li>';
                item_row+='<li>CARET : '+v.caret+'</li>';
                item_row+='</ul>';
                item_row+='</td>';
                item_row+='<td>';
                item_row+='<ul>';
                item_row+='<li>WIGHT : <span class="avl_wght">'+v.gross+"/"+v.net+'</span>Gm</li>';
                item_row+='<li>CODE : '+v.tag+'</li>';
                item_row+='</ul>';
                item_row+='</td>';
                item_row+='</tr>';
                ttl_gross+= +v.gross;
        ...
        $("#avl_wght").text(ttl_gross.toFixed(3)+'/'+ttl_net.toFixed(3));
            ...
            if(code){
                ...
                console.log("Here Not Blank");
                    ...
                    if(!is_scaned){
                        ...
                        $("#miss_wght").empty().append(miss_gross.toFixed(3)+"/"+miss_net.toFixed(3));
                        ...
                        $("#scan_wght").empty().append(scane_gross.toFixed(3)+"/"+scane_nettoFixed(3));
                    }else{
