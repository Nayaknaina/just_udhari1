...
$data = new_component_array('newbreadcrumb',"Edit Supplier",$path) 
@endphp 
        ...
        <div class = "row justify-content-center">
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    ...
                    <input type="text" name="mobile_no" class="form-control form-group" placeholder="Enter Mobile No" value = "{{ $supplier->mobile_no }}" oninput="digitonly(event,10)">
                </div>
				<div class="col-lg-4">
