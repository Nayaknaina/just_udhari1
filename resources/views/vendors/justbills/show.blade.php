...
@php 
//$anchor = ['<a href="'.route('bills.edit',$justbill->id).'" style="float:right;" class="btn btn-sm bg-light border-dark text-dark"><i class="fa fa-edit"></i> Edit</a>','<a href="'.route('bills.index').'" class="btn btn-sm btn-outline-info"><i class="fa fa-list"></i> All</a>'];
...
$data = new_component_array('newbreadcrumb',"Just Bill Info",$path) 
@endphp 
