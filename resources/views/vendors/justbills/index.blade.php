...
//$data = component_array('breadcrumb' , 'Just Bill List',[['title' => 'Just Billing']] ) ;
...
@php 
$anchor = ['<a href="'.route('bills.create').'" class="btn btn-sm btn-outline-primary"><i class="fa fa-plus"></i> New</a>'];
$data = new_component_array('newbreadcrumb',"Just Bills") 
@endphp 
