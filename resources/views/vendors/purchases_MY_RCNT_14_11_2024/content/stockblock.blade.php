...
<legend class="block_sn px-3">1</legend>
    ...
    <div class="col-lg-3">
        <div class="form-group">
            ...
            <input type="number" class="form-control rate" id = "rate" name = "rate[]" min="1" step="any" placeholder="Enter Rate">
        </div>
    </div>
    ...
    @include('vendors.purchases.content.itemrow')
