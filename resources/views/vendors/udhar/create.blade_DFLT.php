                        ...
                        <form id="udhar_form" action="{{ route('udhar.store') }}" role="form" autocomplete="off">
                            ...
                            <div class="card-body pt-2" id="form_container">
                                <div class="row block_at_bhav_cut">
                                    ...
                                    <div class="col-md-2 offset-md-4 col-2 text-right p-2">
                                        <a href="#" class="btn btn-primary form-control w-auto" id="custo_txn_jump"><i class="fa fa-book" style="vertical-align:bottom;" ></i></a>
