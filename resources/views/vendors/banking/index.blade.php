                                        ...
                                        <div class="row">
                                                <div class="form-group col-md-3 p-0">
                                                    ...
                                                    <select name="cat" id="cat" class="form-control">
                                                        ...
                                                        <option value="artificial" id="artificial">Artificial</option>
                                                ...
                                                <div class="form-group col-md-4 p-0">
                                                    ...
                                                    <select name="type" id="type" class="form-control">
                                                        <option value="">Select</option>
                                                        <option value="jewellery" class="type_option  gold silver artificial" >Jewellery</option>
                                                        <option value="bullion" class="type_option gold silver">Bullion</option>
                                                        <option value="loose" class="type_option gold silver diamond">Loose</option>
                                                        <option value="precious" class="type_option stone">Precious</option>
                                                        <option value="semi precious" class="type_option stone">Semi Precious</option>
                                                        <option value="common" class="type_option default">Common</option>
                                                    </select>
                                                </div>
                                                <div class="form-group col-md-3 p-0">
                                                    <label for="hsn">HSN</label>
                                                    <input type="text" name="hsn" id="hsn" value="" class="form-control" placeholder="Code"  oninput="digitonly(event,4)">
                                                </div>
                                                <div class="form-group col-md-2 p-0">
                                                    <label for="gst">GST %</label>
                                                    <input type="text" name="gst" id="gst" value="" class="form-control" placeholder="% Value" >
                                                </div>
                                        </div>
                                        <hr class="col-12 m-1 p-0">
                                        <div class="form-group col-12 text-center  p-1">
                                        ...
                                        <tbody id="billing-Info">
                                            @if(count($billing)>0)
                                                @foreach($billing as $b_i=>$bill)
                                                    <tr class="{{ ($bill->active==0)?'table-danger':(($bill->status=='off')?'table-warning':'') }}" >
                                                        <td>
                                                            @if($bill->active)
                                                            ...
                                                            @else 
                                                            <a href="{{ url("vendors/banking/deletehsn/{$bill->id}") }}" class="btn btn-danger delete_info  px-1 py-0 m-1" data-target="HSN/GST Info"><li class="fa fa-times"></li></a>
                                                            @endif
                                                        </td>
                                                        <td class="text-center"> {{ $bill->category }}</td>
                                                        <td class="text-center"> {{ $bill->type }}</td>
                                                        <td class="text-center">{{ @$bill->hsn??'-----' }}</td>
                                                        ...
                                                        <td class="text-center">
                                                            ...
                                                            @else 
                                                            <label class="text-danger">&cross;</label>
                                                            @endif
                                                        </td>
                                                    </tr>
                                                @endforeach
                                            @else 
                                            <tr><td colspan="6" class="text-center text-danger">No Info !</td></tr>
                                            @endif
                                        </tbody>
                                    </table>
                                </div>
    ...
    <div class="modal fade" id="edit_model" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
                <div class="modal-header p-2" style="background: #f956001a;">
                    <h6 class="modal-title " id="modal_head"></h6>
                    <button type="button" class="close text-danger" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body py-0" id="edit_body">
