                    ...
                    <form id = "submitForm" method="POST" action="{{ route('bills.store')}}" class = "myForm" enctype="" autocomplete="off">
                        ...
                        <div class="row mb-2" style="border-bottom:1px solid #a6a6a6;">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group mb-1">
                                    ...
                                    <input type="text" name="vndr_gst" id="vndr_gst" class="form-control" placeholder="GST Number" value="" required>
                                </div> 
                                <div class="input-group mb-1">
                                    <div class="input-group-prepend">
                                        <label for="hsn" class="input-group-text mb-0">HSN Code</label>
                                    </div>
                                    <select name="hsn" id="hsn" class="form-control" required>
                        ...
                        <div class="row mb-2" style="border-bottom:1px solid #a6a6a6;">
                            ...
                            <div class="col-md-3 col-12 p-1">
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        <label class="input-group-text px-1" id="basic-addon1">GST({{ getgstval() }})%</label>
                                    </div>
                                    <input type="hidden" name="gst_set" value="{{ getgstval() }}">
