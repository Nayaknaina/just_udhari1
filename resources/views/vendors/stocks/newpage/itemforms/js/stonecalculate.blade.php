...
@endphp
<script>
$(document).on('change.stone','.caret',function(){
    const index = itemcheck($(this));
});

$(document).on('input.stone','.gross',function(){
    const index = itemcheck($(this));
...
$(document).on('input.stone','.less',function(){
    const index = itemcheck($(this));
...
$(document).on('blur.stone','.tunch',function(){
    const index = itemcheck($(this));
...
$(document).on('input.stone','.tunch',function(){
    const index = itemcheck($(this));
...
$(document).on('input.stone','.wstg',function(){
    const index = itemcheck($(this));
    const net = $(document).find('.net').eq(index);
...
$(document).on('input.stone','.chrg',function(){
    const index = itemcheck($(this));
...
$(document).on('input.stone','.rate',function(){
    const index = itemcheck($(this));
    const net = $(document).find('.net').eq(index).val()??false;
    if(!net){
        toastr.error("Net Missing Re-Enter the Gross !");
...
$(document).on('input.stone','.lbr',function(){
    const index = itemcheck($(this));
    const net = $(document).find('.net').eq(index).val()??false;
    if(!net){
        toastr.error("Net Missing Re-Enter the Gross !");
...
$(document).on('change.stone','.lbrunit',function(){
    const index = itemcheck($(this));
...
$(document).on('input.stone','.disc',function(){
    const index = itemcheck($(this));
    const net = $(document).find('.net').eq(index).val()??false;
    if(!net){
        toastr.error("Net Missing Re-Enter the Gross !");
...
$(document).on('change.stone','.discunit',function(){
    const index = itemcheck($(this));
...
$(document).on('input.stone','.other',function(){
    const index = itemcheck($(this));
    const net = $(document).find('.net').eq(index).val()??false;
    if(!net){
        toastr.error("Net Missing Re-Enter the Gross !");
...
$(document).on('input.stone','.ttl',function(){
    calculatesum();
});
