                      ...
                      <div class="row mb-2" style="border-bottom:1px solid #a6a6a6;">
                        ...
                        <div class="row mb-2" style="border-bottom:1px solid #a6a6a6;" id="pre_pay_option">
                            ...
                            <div class="col-md-3 col-12 form-group">
                                ...
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control readonly" name="amount[]" id="amount" placeholder="Enter Amount !" oninput="validalance()" onkeyup="validalance()"  value="" readonly>
                                ...
                                <div class="row mb-2 more_payment_row" style=""> 
                                    <div class="col-md-3 pay_col">
                                        <div class="input-group input-group-sm">  
                                            ...
                                            <input type="hidden" class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm" name="pre_mode[]" value="{{ $pay->mode }}" readonly >
                                    ...
                                    <div class="col-md-3 pay_col">
                                        <div class="input-group input-group-sm">  
                                            ...
                                            <input type="hidden" class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm" name="pre_medium[]" value="{{ $pay->medium }}" readonly >
                                    ...
                                    <div class="col-md-3 pay_col">
                                        <div class="input-group input-group-sm">  
                                            ...
                                            <input type="hidden" class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm" name="pre_amount[]" value="{{ $pay->amount }}" readonly >
