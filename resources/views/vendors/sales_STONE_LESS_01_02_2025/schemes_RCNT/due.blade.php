                    ...
                    <div class="card">
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="card group_block">
                                        <a href="{{ route('shopscheme.group','a') }}" class="overlay_anchor"><li class="fa fa-eye"></li></a>
                                ...
                                <div class="col-md-3">
                                    <div class="card group_block">
                                    <a href="{{ route('shopscheme.group','b') }}" class="overlay_anchor"><li class="fa fa-eye"></li></a>
                                        <div class="card-body p-2 row">
                                            <div class="col-7 p-0">
                                                <div class="title_block pl-2">
                                                    <h5>Group B (LL)</h5>
                                ...
                                <div class="col-md-3">
                                    <div class="card group_block">
                                        <a href="{{ route('shopscheme.group','c') }}" class="overlay_anchor"><li class="fa fa-eye"></li></a>
                                        <div class="card-body p-2 row ">
                                            <div class="col-7 p-0">
                                                <div class="title_block  pl-2">
                                                    <h5>Group C (LL)</h5>
                                ...
                                <div class="col-md-3">
                                    <div class="card group_block">
                                        <a href="{{ route('shopscheme.group','d') }}" class="overlay_anchor"><li class="fa fa-eye"></li></a>
                                        <div class="card-body p-2 row ">
                                            <div class="col-7 p-0">
                                                <div class="title_block  pl-2">
                                                    <h5>Group D (LL)</h5>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="card group_block">
                                        <a href="{{ route('shopscheme.group','e') }}" class="overlay_anchor"><li class="fa fa-eye"></li></a>
                                        <div class="card-body p-2 row">
                                            <div class="col-7 p-0">
                                                <div class="title_block pl-2">
                                                    <h5>Group A (SL)</h5>
                                ...
                                <div class="col-md-3">
                                    <div class="card group_block">
                                        <a href="{{ route('shopscheme.group','f') }}" class="overlay_anchor"><li class="fa fa-eye"></li></a>
                                        <div class="card-body p-2 row">
                                            <div class="col-7 p-0">
                                                <div class="title_block  pl-2">
                                                    <h5>Group B (SL)</h5>
                                ...
                                <div class="col-md-3">
                                    <div class="card group_block">
                                        <a href="{{ route('shopscheme.group','g') }}" class="overlay_anchor"><li class="fa fa-eye"></li></a>
                                        <div class="card-body p-2 row ">
                                            <div class="col-7 p-0">
                                                <div class="title_block  pl-2">
                                                    <h5>Group C (SL)</h5>
                                ...
                                <div class="col-md-3">
                                    <div class="card group_block">
                                        <a href="{{ route('shopscheme.group','h') }}" class="overlay_anchor"><li class="fa fa-eye"></li></a>
                                        <div class="card-body p-2 row ">
                                            <div class="col-7 p-0">
                                                <div class="title_block  pl-2">
                                                    <h5>Group D (SL)</h5>
