        ...
        <div class = "row justify-content-center">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 form-group ">
                    ...
                    <select name="scheme_id" class="form-control select2">
                        ...
                        @foreach ($schemes as $scheme )
                            <option value="{{ $scheme->id }}">{{ $scheme->schemes->scheme_head }}</option>
                        @endforeach
                    </select>
                </div>
                ...
                <div class="col-lg-6 form-group ">
                    ...
                    <input type = "number" name="emi_amt" id = "emi_amt" class="form-control form-group" placeholder = "Enter EMI Amt"  >
                </div>
