                                                ...
                                                <tr id="item_{{ $i }}" class="item_row">
                                                    ...
                                                    <td>
                                                        <div class="col-12 p-0">
                                                            ...
                                                            <ul class="pre_info">
                                                                <li><h5 class="dflt_val curr_cate"></h5></li>
                                                                <li><b>RATE - </b>
                                                                    <input type="text" name="curr_rate" class="item_info dflt_val p-0" value="" id="" disabled >
                                                                </li>
                                                                <li><b>CHRG - </b>
                                                                    <input type="text" name="curr_make" class="item_info dflt_val p-0" value="" id="" disabled>
                                                                </li>
                                                                <li><b>AVAIL - </b>
                                                                    <input type="text" name="curr_avail" class="item_info dflt_val p-0" value="" id="" disabled>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <input type="text" name="chrg_perc[]" class="form-control w-100 item_info  text-right  px-1" placeholder="Charge %"  oninput="calculatetotal()">
                                                    </td>
                                                    <td>
                                                        <input type="text" name="item_chrg[]" class="form-control w-100 item_info  text-right  px-1" placeholder="Charge Rs."  oninput="calculatetotal()">
                                                    </td>
                                                    <td>
