                                  ...
                                  <tbody id="item_body">
                                      ...
                                      <tr id="item_{{ $ik }}" class="item_row">
                                          ...
                                          <td>
                                              ...
                                              <input type="hidden" name="type[]" value="{{ ($item->stock->item_type!="loose")?ucfirst($item->stock->item_type):'Loose' }}">
                                          ...
                                          <td class="bg-light text-dark">
                                              <input type="text" name="curr_make" class="form-control item_info" value="{{ $item->stock->labour_charge }}" id="" disabled >
                                          </td>
