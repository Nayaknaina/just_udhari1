                  ...
                  <form id = "submitForm" method="POST" action="{{ route('sells.update',$sell->id)}}" class = "myForm" enctype="">
                      ...
                      <div class="row mb-2" style="border-bottom:1px solid #a6a6a6;">
                        ...
                        <div class="col-md-8">
                            ...
                            <label for="to">
                                <div class="input-group">
                                    <select class="form-control" name="to" style="font-weight:bold;color:#044fdd;" required id="to">
                            ...
                            @php  
                                ...
                                $$gst_apply = 'checked';
                            @endphp
                            <label  class="bg-light h-auto px-1 mb-1" style="box-shadow: 1px 2px 3px black;float:right">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-7 p-0 mb-1">
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                        ...
                        <div class="row mb-2" style="border-bottom:1px solid #a6a6a6;">
                            ...
                            <div class="col-md-3 col-12  p-1 {{ ($sell->gst_apply==0)?'deactive':''; }}" id="gst_block">
                                <div class="input-group mb-3" >
                                    @php 
