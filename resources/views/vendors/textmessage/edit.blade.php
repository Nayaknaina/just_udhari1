...
$data = new_component_array('newbreadcrumb',"Edit  Msg ".ucfirst($edit),$path) 
@endphp 
                              ...
                              <div class="col-6 m-auto" style="border-bottom:1px solid lightgray;">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-5">
                                        ...
                                        <input type="text" name="sender" value="{{ $edit_data->sender_id }}" class="form-control">
                                    </div>
                              ...
                              <div class="col-6 m-auto" style="border-bottom:1px solid lightgray;">
                                <div class="row">
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="text" class="form-control" name="id" placeholder="Message ID" value="{{ $edit_data->msg_id }}">
                                    </div>
