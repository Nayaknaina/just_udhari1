...
@php 
$anchor = ['<a href="'.route('textmsgeapi.index').'" class="btn btn-sm btn-outline-secondary"><i class="fa fa-object-group"></i> Api Info</a>'];
$path = ["Txt Msg Api Setting"=>route('textmsgeapi.index')];
$data = new_component_array('newbreadcrumb',"New Msg".ucfirst($new),$path) 
@endphp 
            ...
            <div class = "row justify-content-center">
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <h3 class="card-title"><x-back-button />  New Txt Msg {{ ucfirst($new) }}</h3>
                        </div>-->
                    </div>
                    ...
                    <form id = "submitForm" method="POST" action="{{ route('textmsgeapi.store')}}" class = "myForm" enctype="" autocomplete="off">
                       ...
                       @switch($new)
                            @case("url")
                                <div class="col-md-6 m-auto p-0" style="border-bottom:1px solid lightgray;">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="key" placeholder="Alpha numeric Value ( Received From DLT Pltform )">
                                    </div>
                                    <div class="row">
                                ...
                                <div class="col-md-6 m-auto p-0" style="border-bottom:1px solid lightgray;">
                                    <div class="row">
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" class="form-control" name="id" placeholder="The Message ID You Get From DLT Portal">
                                        </div>
