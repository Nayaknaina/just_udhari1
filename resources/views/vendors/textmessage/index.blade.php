...
@php 
$data = new_component_array('newbreadcrumb',"Text Message Api Setting") 
@endphp 
                        ...
                        <div class="card-body row">
                            ...
                            <div class="card m-auto col-md-6 p-0 {{ isset($apiurl->status)?$border_arr[$apiurl->status]:null }}">
                                ...
                                <div class="card-body p-2">
									<div class="form-group m-auto w-auto p-1 h-auto">
                                        <label class=""><b>Sender Id =></b></label>
                            ...
                            <div class="col-12 p-0">
                                ...
                                <div class="table-responsive">  
                                    <table class="table table_theme table-bordered table-stripped" id="CsTable">
                                        <thead>
                                            <tr class="">
                                                <th>SN.</th>
                                                <th>ID/HEAD</th>
