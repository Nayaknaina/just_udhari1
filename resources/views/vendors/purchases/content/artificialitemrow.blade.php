<table class = "table table_theme table-responsive table-bordered artificial dataTable pb-2" >
    ...
    <tbody id="tableBody" class="item_tbody">
        <tr id="main_item_tr_1" class="main_item_tr">
			...
			<!--<td> 
                <input type="text" class="tb_input  artifical" name="barcode[artificial][]" id="barcode_1" placeholder="Barcode" value=""  > 
            </td>-->
			<td> 
                <input type="text" class="tb_input artifical" name="rfid[artificial][]" id="rfid_1" placeholder="RFID" value=""  > 
            </td>
            <td> 
                <input type="number" class="tb_input amount calculate_item artifical" name="rate[artificial][]" id="rate_1" placeholder="Rate/Unit" min = "0" step = "any"   > 
            </td>
        </tr>
