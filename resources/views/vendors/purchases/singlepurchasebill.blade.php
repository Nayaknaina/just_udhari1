...
@if(!empty($purchase))
        <ul class="row p-0 mb-1" style="list-style:none;">
        ...
        <ul class="row p-0 mb-1" style="list-style:none;">
            ...
            <li class="col-md-2 text-right text-info"><b><i> {{ $purchase->total_amount??0 }} Rs.</i></b> </li>
            <li class="col-md-2"><b>PAID</b></li>
            <li class="col-md-2 text-right text-success"><b><i> {{ $purchase->pay_amount??0 }} Rs.</i></b></li>
            <li class="col-md-2"><b>REMAINS</b></li>
            <li class="col-md-2 text-right text-danger"><b><i> {{ $purchase->remain??0 }} Rs.</i></b> </li>
        </ul>
        <hr class="m-1">
                    ...
                    <tr class="table-secondary">
                        ...
                        <td class="text-center">
                            @if($stock->item_type=='other') 
                                <b>-----</b>
                            @else
                                <b>{{ ($purchase->total_quantity==0)?'-----':$purchase->total_quantity }}</b>
                            @endif  
                        </td>
                        <td colspan="2"></td>
                        <td class="text-center">
