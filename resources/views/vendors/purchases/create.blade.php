...
$data = new_component_array('newbreadcrumb',"New Purchase",$path) 
@endphp 
        ...
        <div class = "row justify-content-center">
            ...
            <div class="row mb-2" style="border-bottom:1px solid #a6a6a6;">
				<div class="col-md-3 p-0">
                    <label for="stocktype" class="mb-0">Stock Type ?</label>
                    <select id="stocktype" class="form-control m-0 text-center" name="stocktype" >
                ...
                <div class="col-lg-3 p-0">
                    ...
                    <label for="stocktype" class="mb-0"> Supplier </label>
					<div class="input-group">
						<select name = "supplier" class = "form-control select2 w-auto text-center" id="supplier">
							<option value="">Select</option>
						...
						<div class="input-group-append">
							<a href="javascript:void(null)" data-toggle="modal" data-target="#newsupplier" id="supplr_plus_" class="btn btn-outline-primary px-2" style="align-content:center;"><li class="fa fa-plus"></li></a>
						</div>
					</div>
                </div>

                <div class="col-lg-2 p-0">
                    <label for="bill_no" class="mb-0"> Bill No </label>
                    <input type="text" name="bill_no" id="bill_no" class="form-control text-center" placeholder="Enter Bill No "  >
                </div>

                <div class="col-lg-2 p-0">
                    <label for="bill_date" class="mb-0"> Bill Date </label>
                    <input type="date" name="bill_date" id="bill_date" class="form-control text-center" placeholder="Enter Bill Date" max = "{{ date('Y-m-d') }}">
                </div>

                <div class="col-lg-2 p-0">
                    <label for="batch_no" class="mb-0"> Batch No </label>
                    <input type="text" name = "batch_no" id="batch_no" class="form-control text-center" placeholder="Enter Batch No ">
                </div>
            ...
            <div class="row"  id="pre_pay_option">
                ...
                <div class="col-md-3 col-12 form-group  mb-2">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control readonly" name="amount" id="amount" placeholder="Enter Amount !" disabled="" value="0">
                        <div class="input-group-append">
