...
$artificial = $purchase->stocks->where('item_type','artificial');
//dd($artificial);
$genuine = $purchase->stocks->where('item_type','genuine');
          ...
          <hr>
            <div class="row small_input ">
                <div class="col-12 bg-light mb-2 p-0" style="border:1px solid lightgray;">
                    <h4 class="m-2"> Stock Details - Artificial Jewellery</h4>
                </div>
                ...
                <table class = "table table-responsive table-bordered artificial" >
                    ...
                    <tbody id="tableBody" class="item_tbody">
                        ...
                        @foreach($artificial as $artk=>$artv)
                        <tr id="main_item_tr_1" class="main_item_tr">
                            ...
                            <td> 
                                <input type="number" class="tb_input amount calculate_item artifical" name="amount[artificial][]" id="amount_1" placeholder="Amount" min = "0" step = "any" value="{{ round($artv->quantity*$artv->amount) }}"   > 
                            </td>
                        </tr>
                        @endforeach
                        @else 
            ...
            <div class="row small_input ">
                <div class="col-12 bg-light mb-2 p-0" style="border:1px solid lightgray;">
                    <h4 class="m-2"> Stock Details - Genuine Jewellery</h4>
                </div>
            </div>
        @php 
            $count = 0;
