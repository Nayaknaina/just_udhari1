...
@php 
$anchor = ['<a href="'.route('girvi.ladgerbook').'" class="btn btn-sm btn-outline-info"><i class="fa fa-list"></i> Ladger</a>','<a href="#" class="btn btn-sm btn-outline-secondary"><i class="fa fa-list"></i> List</a>'];
$data = new_component_array('newbreadcrumb',"New Girvi") 
@endphp 
