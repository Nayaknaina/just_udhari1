...
@php 
$anchor = ['<a href="'.route('girvi.create').'" class="btn btn-sm btn-outline-primary"><i class="fa fa-plus"></i> New</a>','<a href="'.route('girvi.ladgerbook').'" class="btn btn-sm btn-outline-info"><i class="fa fa-list"></i> Ladger</a>','<a href="'.route('girvi.grirvilist').'" class="btn btn-sm btn-outline-secondary"><i class="fa fa-list"></i> List</a>'];
$data = new_component_array('newbreadcrumb',"Girvi Transaction") 
@endphp
