                                            ...
                                            <div class="card-body row pt-0 pb-0">
                                                ...
                                                <div class="col-12 border-1 p-0 title_block_value">
                                                    <ul class="title_value m-0">
                                                        <li class="text-primary total"><b>TOTAL</b><span>{{ $scheme['payable']}}</span></li>
                                                        <li class="text-success received"><b>RECEIVED</b><span>{{ $scheme['received']}}</span></li>
                                                        <li class="text-danger remains"><b>REMAINS</b><span>{{ $scheme['payable']-$scheme['received']}}</span></li>
                                                    </ul>
                                                    <h6 class="bg-danger text-center ml-1">BONUS : -{{ $scheme['bonus'] }}</h6>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="card card-default">
                                            <div class="card-header p-2">
                                                <h3 class="card-title col-12 p-0" style="color:inherit;">{{ $group['name'] }} </h3>
                                            </div>
                                                ...
                                                <div class="col-12 border-1 p-0 title_block_value">
                                                    <ul class="title_value m-0 pl-4">
                                                        ...
                                                        <li class="text-danger remains">
                                                            <b>REAMINS</b>
                                                            <span>{{ $group['payable']-$group['received'] }}</span>
                                                        </li>
                                                        
                                                    </ul>
                                                    <h6 class="border-danger text-center ml-1"><b>BONUS : </b> -{{ $group['bonus'] }}</h6>
                                                </div>
                                                @if($group['start'])
                                                <hr class="m-0 col-12 sub_hr p-0">
                                                <div class="col-12 border-1 p-0 title_block_value">
                                                    <h6 class="m-2">THIS MONTH <a href="{{ route("shopscheme.enrollgroup",$group['id']) }}" class="group_detail_show" style="float:right"><li class="fa fa-eye"></li></a></h6>
                                                    <hr class="m-0 col-12 sub_hr p-0">
                                                    <ul class="title_value m-0 pl-4">
                                                        <li class="text-primary total">
                                                            <b>TOTAL</b>
                                                            <span>{{ $group['month_payable'] }}</span>
                                                        </li>
                                                        <li class="text-success received">
                                                            <b>RECEIVED</b>
                                                            <span>{{ $group['month_received'] }}</span>
                                                        </li>
                                                        <li class="text-danger remains">
                                                            <b>REAMINS</b>
                                                            <span>{{ $group['month_payable']-$group['month_received'] }}</span>
                                                        </li>
                                                    </ul>
                                                </div>
                                                @endif
