  ...
  <section class = "content">
        ...
        <div class = "row justify-content-center">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 form-group ">
                    <label for="customer_id"> Customer </label><a href="#"  id="custo_plus"><li class="fa fa-plus-square" ></li></a>
    ...
    <div class="modal" tabindex="-1" role="dialog" id="custo_modal" data-backdrop="static" data-keyboard="false">
        <div class="modal-dialog modal-sm" role="document" >
            ...
            <form action="{{ route('enrollcustomer/newcustomer') }}" method="post" id="custo_plus_form">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="addr" id="addr" class="form-control custo" rows="5" placeholder="Customer Address" required></textarea>
            ...
            $.post(path,formdata,function(response){
                if(response.valid){
                    if(response.status){
                        ...
                        const option = '<option value="'+custo.id+'" data-name = "'+custo.custo_full_name+'" >'+custo.custo_full_name+'</option>';
