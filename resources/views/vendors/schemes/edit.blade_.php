                    ...
                    <form id = "submitForm" method="POST" action="{{ route('shopscheme.update',$schemedetail->id)}}" class = "myForm" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="date" name="launch_date" id="launch_date" class="form-control text-center" value="{{ $schemedetail->launch_date }}" required>
                            </div>
                            ...
                            <div class="col-md-4 form-group">
                                ...
                                <input type="date" name="start_date" id="launch_date" class="form-control text-center" value="{{ $schemedetail->scheme_date }}" {{ ($schemedetail->scheme_date_fix=='1')?'required':'' }}>
                            </div>
                            @endif
