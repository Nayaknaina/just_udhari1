...
@php 
$anchor = ['<a href="'.route('anjuman.all.scheme').'" class="btn btn-sm btn-outline-info"><i class="fa fa-list"></i> All</a>'];
$data = new_component_array('newbreadcrumb',"New Anjuman Scheme") 
@endphp 
            ...
            <div class = "row justify-content-center">
                <div class="col-md-8">
                    <div class="card card-primary mt-1" style="border-top:1px dashed #ff2300;">
                        <form role="form" id="scheme_form" action="{{ route('anjuman.new.scheme.save')}}"> 
