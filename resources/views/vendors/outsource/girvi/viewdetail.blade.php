                    ...
                    <div class="col-md-6 mb-1 px-0 mobile-hidden" style="justify-items: end;     align-self: end;">
                        <div class=" ">
                            <div class="action-buttons">
                                <a href="{{route('vendor.girvi.ledger')}}" class=" btn-outline-primary btn-icon btn-rounded _effect--ripple waves-effect waves-light">
                                ...
                                <div class="hover-menu-wrapper">
                                    ...
                                    <div class="hover-menu">
                                        <a href="{{ route('vendor.girvi.list') }}">Current List</a>
                                        <a href="{{ route('vendor.girvi.list') }}">Old List</a>
                                        <a href="{{ route('vendor.girvi.list') }}">Detail List</a>
                                    </div>
                                </div>
                            </div>
                        </div>
