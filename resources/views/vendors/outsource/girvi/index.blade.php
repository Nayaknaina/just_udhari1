        ...
        <div class="row">
            ...
            <style>
                ...
                .nav-ul li.active-li {
                    ...
                    box-shadow: 0px -2px 8px rgb(255 153 51 / 31%);
                ...
                .nav-ul li {
                    ...
                    /* Default border for non-active tabs */
                    padding: 8px 5px;
                ...
                .curve {
                    border-bottom: 5px solid #ff6e26;
                }
                ...
                .btn-outline-default.active {
                    border-top: 2px solid #ff6e26 !important;
                    color: red;
                    ...
                    <div class="card-body pb-0">
                        <div class="row">
                            <div class="col-md-6 mb-1">
                                <div class="mb-2 row">
                                    <label class="col-sm-4 fs-13px pr-1">Customer Name :</label>
                                    <div class="col-sm-8">
                                        <div class="input-group position-relative">
                                            <input class="form-control h-32px round border-success" type="text" placeholder="Enter Name">
                                            <button class="add-btn"><span class="add-icon">+</span></button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 mb-1">
                                <div class="mb-2 row">
                                    <label class="col-sm-4 fs-13px pr-1">Mobile No-/ Girvi Id :</label>
                                    <div class="col-sm-8">
                                        <div class="input-group position-relative">
                                            <input class="form-control h-32px round border-success" type="text" placeholder="Enter Number">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <div class="customer-info">
                                                <div class="mb-2 row">
                                                    <label class="col-sm-3 fs-13px pr-1">Customer Name </label>
                                                    <label class="col-sm-1 fs-13px pr-1"> :</label>
                                                    <div class="col-sm-8">
                                                        <h6>Customer Name</h6>
                                                    </div>
                                                </div>
                                                <div class="mb-2 row">
                                                    <label class="col-sm-3 fs-13px pr-1">Girvi ID </label>
                                                    <label class="col-sm-1 fs-13px pr-1"> :</label>
                                                    <div class="col-sm-8">
                                                        <h6>12345</h6>
                                                    </div>
                                                ...
                                                <div class="mb-2 row">
                                                    <label class="col-sm-3 fs-13px pr-1">Mobile Number </label>
                                                    <label class="col-sm-1 fs-13px pr-1"> :</label>
                                                    <div class="col-sm-8">
                                                        <h6>9988776655</h6>
                                                    </div>
