                    ...
                    <div class="card-body ">
                        <div class="mb-3 d-flex" style="justify-content: space-between;">
                            <div class="action-buttons">
                                ...
                                <a href="{{ route('vendor.exchange.reciept') }}" class="btn btn-outline-primary  btn-rounded">
                                    Sample Reciept
                                </a>
                            </div>
                            <div>
                                <div class="hover-menu-wrapper">
                                    ...
                                    <div class="hover-menu">
                                        <a href="{{ route('vendor.exchange.list') }}">Current List</a>
                                        <a href="{{ route('vendor.exchange.list') }}">Old List</a>
                                        <a href="{{ route('vendor.exchange.list') }}">Detail List</a>
                                    </div>
                                </div>
                            </div>
                        </div>
