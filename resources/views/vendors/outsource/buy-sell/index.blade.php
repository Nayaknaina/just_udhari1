...
@php $data = new_component_array('breadcrumb',"Buy-Sell (खरीद बिक्री)") @endphp
                                ...
                                <div class="tab-content" id="pills-tabContent">
                                        ...
                                        <div class=" ">
                                            <div class="row">
                                                <div class="col-md-12 mb-1">
                                                    <div class="mb-2 row">
                                                        <label class="col-sm-4 fs-13px pr-1"> Name :</label>
                                                        <div class="col-sm-8">
                                            ...
                                            <div class="row">
                                                <label class="col-sm-4 fs-13px pr-1"> (खरीदना) Buy Weight :</label>
                                            ...
                                            <div>
                                                <div class="row">
                                                    <div class="col-md-6 mb-1">
                                                        <div class="input-group position-relative">
                                                            <input class="form-control h-32px btn-roundhalf border-dark" type="text" placeholder="(खरीदना) Buy Rate">
                                                            <span class="gm-inside">₹/10gm</span>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6 mb-1">
                                                        <div class="input-group position-relative">
                                                            <input class="form-control h-32px btn-roundhalf border-success " type="text" placeholder="Cash">
                                                            <span class="gm-inside">gm</span>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6 mb-1">
                                                        <div class="input-group position-relative">
                                                            <input class="form-control h-32px btn-roundhalf border-dark" type="text" placeholder="Given Cash">
                                                            <span class="gm-inside">₹</span>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6 mb-1">
                                                        <div class="input-group position-relative">
                                                            <input class="form-control h-32px btn-roundhalf border-dark" type="text" placeholder="Online Given RTGS">
                                                            <span class="gm-inside">₹</span>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="tab-pane fade " id="pills-sell" role="tabpanel" aria-labelledby="pills-sell-tab" tabindex="0">
                                        <div class=" ">
                                            ...
                                            <div class="row">
                                                <label class="col-sm-4 fs-13px pr-1"> (बेचना) Sell Weight :</label>
                                                <div class="col-md-8 col-6 ">
                                                    <div class="input-group position-relative">
                                                        <input class="form-control h-32px btn-roundhalf border-dark " type="text"
                                                            placeholder=" Weight (gm)">
                                                        <button class="add-btn toggle-loan-btn1" type="button">
                                                            <span class="add-icon">+</span>
                                                        </button>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class=" row loan-details-form1 mb-2" style="display: none;">
                                                <div class="col-md-12">
                                                    <table class="custom-table bg-header-primary">
                                                        <thead>
                                                            <tr>
                                            ...
                                            <div>
                                                <div class="row">
                                                    <div class="col-md-6 mb-1">
                                                        <div class="input-group position-relative">
                                                            <input class="form-control h-32px btn-roundhalf border-dark" type="text" placeholder="(बेचना) Sell Rate">
                                                            <span class="gm-inside">₹/10gm</span>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6 mb-1">
                                            ...
                                            <script>
                                                $(document).ready(function() {
                                                    $(".toggle-loan-btn1").click(function() {
                                                        $(".loan-details-form1").slideToggle("fast");
                    ...
                    <div class="card-body ">
                        <div class="mb-3 d-flex" style="justify-content: space-between;">
                            <div class="action-buttons">
                                ...
                                <!-- <a href="{{ route('vendor.buy-sell.list') }}" class="btn btn-outline-secondary  btn-rounded _effect--ripple waves-effect waves-light">
                                    <i class="fa-solid fa-list"></i>
                                </a> -->


                                <a href="{{ route('vendor.buy-sell.reciept') }}" class="btn btn-outline-primary  btn-rounded">
                                    Bhav Booking
                                </a>
                            </div>
                            <div>
                                <div class="hover-menu-wrapper">
                                    ...
                                    <div class="hover-menu">
                                        <a href="{{ route('vendor.buy-sell.list') }}">Current List</a>
                                        <a href="{{ route('vendor.buy-sell.list') }}">Old List</a>
                                        <a href="{{ route('vendor.buy-sell.list') }}">Detail List</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <label class="col-md-4 fs-10px pr-1"></label>
                            <label class="col-md-4 fs-10px pr-1">Fine se Jama (+) :</label>
                        ...
                        <div class="row">
                            <label class="col-md-4 fs-10px pr-1"></label>
                            <label class="col-md-4 fs-10px pr-1">Fine se Udhar (-) :</label>
