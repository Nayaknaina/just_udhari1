...
/*$(".cstm_menu_toggle").click(function(){
    $(this).closest('ul.menu-categories').toggleClass('collapse expand');
    $(this).closest('nav#compactSidebar').toggleClass('min max');
    $("#content.main-content").toggleClass('expand');
    // $(".header.navbar").toggleClass('expand');
});*/

$(".cstm_menu_toggle").click(function(){
    $(this).closest('li.menu_toggle_btns').toggleClass('collapse expand');
