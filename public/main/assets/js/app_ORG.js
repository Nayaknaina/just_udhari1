            ...
            for (var i = 0; i < getMenu.length; i++) {
                getMenu[i].addEventListener('click', function() {
                    ...
                    if ( this.classList.contains('menu-single') ) {
                        ...
                        const dataTablesScrollHeadInner = document.querySelector(".dataTables_scrollHeadInner") ;

                        const submenu = document.querySelector("#compact_submenuSidebar");

                        if (getMenuShowElement && cr_clsss == 'menu show' ) {
                            ...
                            //     dataTablesScrollHeadInner.style.width = "1172px";
                            // }
                        } else {
                            this.classList.remove('active'); 
                            this.classList.add('show') ; 
                            // if(table){ 
                            //     table.style.width = "100%"; // Reset or adjust accordingly
                            //     dataTablesScrollHeadInner.style.width = "998px"; // Reset or adjust accordingly
                            // }
                        }
