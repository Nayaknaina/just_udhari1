...
(function (root, factory) {
    ...
    var DateRangePicker = function(element, options, cb) {
        ...
        this.clearButtonClasses = 'btn-danger';
        ...
        if (typeof options.template !== 'string' && !(options.template instanceof $))
            ...
            '<div class="daterangepicker">' +
                ...
                '<div class="drp-buttons">' +
                    '<button class="clearBtn" type="button" style="float:left;"></button>' +
        ...
        if (typeof options.clearClass === 'string') //backwards compat
            this.clearButtonClasses = options.clearClass;
