...
namespace App\Http\Controllers\ecomm\cms;

use App\Http\Controllers\Controller;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Validator;
use App\Models\EcommSlider;
use App\Models\EcommHome;
use App\Models\EcommAbout;
use App\Models\EcommContact;
use App\Models\EcommFooter;
use App\Models\EcommSocial;
use App\Models\EcommTerm;
use App\Models\EcommPrivacy;
use App\Models\EcommDesclaimer;
...
class EcommCmsController extends Controller
{
    ...
    public function __construct(){
        $this->loggedin_ecomm = 1;
    }
    public function index(){
        return view("admin.ecomm.dash");
    }

    
///---------------------------HOME PAGE SLIDE & CONTENT-------------------------------------//
    public function home(){
        return view("admin.ecomm.cmshome");
    }
    
    public function homecontent(){
        $ecommslider = new EcommSlider;
        $sliders =  $ecommslider->slider($this->loggedin_ecomm);
    ...
    public function saveslider(Request $request){
        ...
        if($slide_count < 5){
            ...
            if ($validator->fails()) {
                ...
                $input['vndr_id'] = $this->loggedin_ecomm;
    ...
    public function singleslide(Request $request,$unique=null){
        $slide = EcommSlider::where('vndr_id',$this->loggedin_ecomm)->where('slider_unique',$unique)->first();
        if($request->ajax()){
            if(empty($slide)){
    ...
    public function changeslide(Request $request,$unique=null){
        ...
        $existslide = EcommSlider::where('vndr_id',$this->loggedin_ecomm)->where('slider_unique',$unique)->first();
        if(!empty($existslide)){
    ...
    public function slidestatus(Request $request,$unique=null){
        $currslide = EcommSlider::where('vndr_id',$this->loggedin_ecomm)->where('slider_unique',$unique)->first();
        if(!empty($currslide)){
    ...
    public function slideorder(Request $request){
        ...
        if(!empty($data)){
            foreach($data as $key=>$value){
                $order = $key+1;
                $ecommslider = EcommSlider::where('vndr_id',$this->loggedin_ecomm)->where('slider_unique',$value)->first();
    ...
    public function savecontent(Request $request){
        ...
        if ($validator->fails()) {
            ...
            $existcontent = EcommHome::where("vndr_id",$this->loggedin_ecomm)->first();
...
///---------------------------ABOUT PAGE CONTENT------------------------------------------------//
    public function about(){
        return view("admin.ecomm.cmsabout");
    }

    public function aboutdata(){
        $existabout = EcommAbout::where('vndr_id',$this->loggedin_ecomm)->first();

        return response()->json(["content"=>(!empty($existabout))?$existabout:false]);
    }

    public function saveabout(Request $request){
        $existcontent = EcommAbout::where("vndr_id",$this->loggedin_ecomm)->first();
...
///---------------------------CONTACT PAGE CONTENT------------------------------------------------//
    public function contact(){
        return view("admin.ecomm.cmscontact");
    }
...
///---------------------------FOOTER INTRO CONTENT------------------------------------------------//
    public function footer(){
        return view("admin.ecomm.cmsfooter");
    }
...
///---------------------------SOCIAL LINKS CONTENT------------------------------------------------//
    public function social(){
        return view("admin.ecomm.cmssocial");
    }
        ...
        if ($validator->fails()) {
            ...
            if($count > 0){
                ...
                foreach($links as $name=>$link){
                    if($link!=""){
                        $existsocial = EcommSocial::where('vndr_id',$this->loggedin_ecomm)->where('social_icon_name',$name)->first();
    ...
    public function socialstatus(){
        $existsocial = EcommSocial::where('vndr_id',$this->loggedin_ecomm)->first();
        if(!empty($existsocial)){
            $status = ($existsocial->social_status==0)?'1':'0';
            if(EcommSocial::where('vndr_id',$this->loggedin_ecomm)->update(['social_status'=>$status])){                
                $response = ["status"=>true,"msg"=>"Visible Status Changed !"];
            }else{
                $response = ["status"=>false,"msg"=>"Visible Status Changing Failed !"];
            }
...
///---------------------------TERM CONTENT-----------------------------------------------------------//
    public function terms(){
        return view("admin.ecomm.cmsterms");
    }
...
///---------------------------POLICY CONTENT------------------------------------------------//
    public function policy(){
        return view("admin.ecomm.cmspolicy");
    }
...
///---------------------------DESCLAIMER CONTENT------------------------------------------------//
    public function desclaimer(){
        return view("admin.ecomm.cmsdesclmr");
    }
