...
class EcommProductController extends Controller {
    ...
    public function edit(EcommProduct $ecomEcommProduct) {

        return view('vendors.ecommerce.products.edit', compact('ecomEcommProduct')) ;
    ...
    public function store(Request $request) {
        ...
        $product = EcommProduct::create([
            ...
            'EcommProduct_id' => $request->EcommProduct_id,
